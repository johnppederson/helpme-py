...
TEST_CASE("check that updates of kappa and unit cell parameters give the correct behavior.") {
    ...
    SECTION("EFV routines") {
        ...
        forces.setZero();
        virial.setZero();
        pme->setLatticeVectors(21, 22, 20, 93, 92, 90, helpme::LatticeType::XAligned);
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy1).margin(TOL));
        ...
        forces.setZero();
        virial.setZero();
        pme->setLatticeVectors(21.5, 22.2, 20.1, 94, 91, 91, helpme::LatticeType::XAligned);
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy2).margin(TOL));
        ...
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy3).margin(TOL));
        ...
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy4).margin(TOL));
        ...
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy5).margin(TOL));
        ...
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy6).margin(TOL));
        ...
        energy = pme->computeEFVRec(0, charges, coords, forces, virial);
        REQUIRE(energy == Catch::Approx(refEnergy7).margin(TOL));
