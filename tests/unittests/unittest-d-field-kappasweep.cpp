...
TEST_CASE("dipole kappa sweep.") {
    ...
    helpme::Matrix<int> pairList{{0, 1}, {0, 3}, {1, 2}, {2, 3}};
    ...
    SECTION("reciprocal space findif vs analytical") {
        ...
        pme.setLatticeVectors(22, 25, 27, 80, 90, 100, helpme::LatticeType::XAligned);
    ...
    SECTION("check invariance of potential and field w.r.t. kappa") {
        ...
        pme3.setLatticeVectors(35, 35, 35, 85, 90, 95, helpme::LatticeType::XAligned);
        ...
        pme4.setLatticeVectors(35, 35, 35, 85, 90, 95, helpme::LatticeType::XAligned);
        ...
        pme5.setLatticeVectors(35, 35, 35, 85, 90, 95, helpme::LatticeType::XAligned);
    ...
    SECTION("check invariance of E w.r.t. kappa") {
        ...
        REQUIRE(E3 == Catch::Approx(E4).margin(TOL));
        ...
        REQUIRE(E4 == Catch::Approx(E5).margin(TOL));
    }
